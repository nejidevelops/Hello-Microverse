...
```sh
  cd my-folder
  git clone git@github.com:NewtonOmbese/Hello-Microverse.git
```
...
I would like to thank Microverse and Najeeb who we will surely finish this journey together and we will be helping each other out.
